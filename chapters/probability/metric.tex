...
Now that we have some notion of distance, we shall explore how to define a coherent metric on the manifold. First, we shall study this for a Riemannian distance. The notation and the definitions will follow the ones of \cite{schutzGeometricalMethodsMathematical1980}.
...
\end{equation}
\todo{Talk about e and m connections?}