...
\begin{theorem} [Quantum Cramér-Rao bound]
    ...
    \end{equation}
    where $G_{QF}$ and $G_{FS}$ are the matrix representation respectively of the \emph{quantum Fisher metric} and of the \emph{Fubini-Study metric} of $\mathbf{P}\mathcal{H}$.
\end{theorem}

This important result sets an intrinsic limit to the amount of information that we can retrieve from the state of a quantum system.