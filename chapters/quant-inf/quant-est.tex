...
\begin{theorem}
    ...
    \begin{equation}
        (grad\mathrm{E}[A])_\rho^{(e)}=(A-\mathrm{E}_\rho[A])^{(\rho)} \qquad\forall \rho\in\mathbf{P}\mathcal{H}
    \end{equation}
...
We can now develop the quantum version of the Cramér-Rao boun for statistical models. We will proceed similarly to the classical version but we will have to be careful when treating multivariate models.
