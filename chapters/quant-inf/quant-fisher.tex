...
\end{equation}
which corresponds to \cref{eq:exp-zero-ev}.
...
\end{equation}
and since the SLD is a linear map, we have
\begin{equation}
    T_\rho^{(e)}\myPH\equiv T_\rho^{(m)}\myPH\equiv T_\rho\mathfrak{D}
\end{equation}
\todo{Show that pure quantum states are analogous to pure probability distributions?}
...
\end{align}
thus, from \cref{eq:qm-exp-mix}, we have that for pure quantum states
\begin{align}
