...
\end{equation}
where it can be shown that the expression on the right of \cref{eq:trace} is independent of the choice of the orthonormal base. Then we also have the following result from linear algebra
\begin{theorem}
