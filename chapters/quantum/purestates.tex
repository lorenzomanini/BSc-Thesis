...
\end{equation}
then, after the measurement, the state vector is projected onto the subspace of the outcome
\begin{equation}
    \ket{\psi'}=P_x \ket{\psi}
\end{equation}
...
\end{equation}
Finally, we also have the following result from linear algebra
\begin{theorem}
