...
\end{equation} 
and horizontal vector fields are defined in analogy with the vertical ones. We now thus have at every point of $X$ a well-defined notion of motion tangent (vertical) or orthogonal (horizontal) to its fiber.

Intuitively we can now lift any curve in the base space to the fiber bundle by starting from a point on the fiber and then moving orthogonally to it. To precisely define this concept let us now consider the restriction to $O_x$ of the push-forward at every point
\begin{equation}
