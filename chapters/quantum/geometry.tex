...
\begin{align}
    ...
    &=i[A,\rho]
\end{align}
We can then express the pullback of the Fubini-Study metric on $S^{2N-1}$ through the push forward of the tangent vectors
\begin{align}
