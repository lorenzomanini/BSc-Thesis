...
We now introduce some additional requirements to statistical models so that we may define well-behaved manifolds from them. Firstly we regard $S$ as a subset of $\mathcal{A}_1$ equipped with the topology induced by the standard one of $\mathbb{R}^N$. Then we assume that
