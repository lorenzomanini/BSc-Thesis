...
\section{The tangent space and its representations} \label{ch:tgt-space}
...
%Define the isomorphism justifying it as possible and saying it will be useful that way later
...
\subsection*{The exponential representation}
